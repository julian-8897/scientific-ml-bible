...
\author{Compiled for Julian C.\\\small PhD researcher, Astrophysics \& Machine Learning}
\date{\today}
...
\vfill
{\large Compiled for \textbf{Julian C.}}\\[0.3em]
...
\input{chapters/02_classical_numerics.tex}
\input{chapters/03_neural_odes.tex}
\input{chapters/04_pinns.tex}
\input{chapters/05_neural_operators.tex}
\input{chapters/06_operator_theoretic.tex}
\input{chapters/07_hybrid_ude.tex}
\input{chapters/08_geometric_equivariant.tex}
\input{chapters/09_generative_pdes.tex}
\input{chapters/10_uq.tex}
\input{chapters/11_multiscale.tex}
\input{chapters/12_software_benchmarks.tex}
\input{chapters/13_emerging_trends.tex}
\input{chapters/14_appendix.tex}
